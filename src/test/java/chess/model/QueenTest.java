...
public class QueenTest {
    ...
    public void testValidMove(){
        assertTrue(whiteQueen.validMove(0, 0, 0, 5, board), "!white queen can't move vertical");
        assertTrue(blackQueen.validMove(0, 0, 0, 5, board), "!black queen can't move vertical");

        assertTrue(whiteQueen.validMove(0, 0, 5, 0, board), "!white queen can't move horizontal");
        assertTrue(blackQueen.validMove(0, 0, 5, 0, board), "!black queen can't move horizontal");

        assertTrue(whiteQueen.validMove(0, 0, 5, 5, board), "!white queen can't move diagonal");
        assertTrue(blackQueen.validMove(0, 0, 5, 5, board), "!black queen can't move diagonal");

        assertFalse(whiteQueen.validMove(0, 0, 0, 0, board), "!white queen can stay in the same place for a move");
        assertFalse(blackQueen.validMove(0, 0, 0, 0, board), "!black queen can stay in the same place for a move");
    ...
    public void testAttack() {
        ...
        assertTrue(whiteQueen.validMove(0, 0, 5, 0, board), "!white queen can beat figure from the same team horizontally");
        ...
        assertTrue(whiteQueen.validMove(0, 0, 0, 5, board), "!white queen can beat figure from the same team vertically");
        ...
        assertTrue(whiteQueen.validMove(0, 0, 5, 5, board), "!white queen can beat figure from the same team diagonally");
